...
import com.dreampany.quran.ui.activity.LaunchActivity
import com.dreampany.quran.ui.activity.NavigationActivity
...
abstract class ActivityModule {
    ...
    @ActivityScope
    @ContributesAndroidInjector(modules = [SurahsModule::class, MoreModule::class])
