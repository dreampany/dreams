...
private constructor(
    ...
    companion object {
        ...
        ): WifiItem = WifiItem(ItemType.ITEM, item, formatter, currency, sort, order, favorite)
        ...
        fun getInfoItem(
            ...
            order: Order,
            favorite: Boolean = false
        ): WifiItem = WifiItem(ItemType.INFO, item, formatter, currency, sort, order, favorite)
        ...
        fun getQuoteItem(
            ...
            order: Order,
            favorite: Boolean = false
        ): WifiItem = WifiItem(ItemType.QUOTE, item, formatter, currency, sort, order, favorite)
