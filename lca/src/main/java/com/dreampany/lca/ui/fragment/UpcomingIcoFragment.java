 ...
 */
@FragmentScope
public class UpcomingIcoFragment extends BaseFragment {
    ...
    private UpcomingIcoViewModel vm;
...
/*    @Override
    ...
    private void initView() {
        ...
        ViewUtil.setText(this, R.id.text_empty, R.string.empty_upcoming_ico);
        ...
        vm = ViewModelProviders.of(this, factory).get(UpcomingIcoViewModel.class);
        vm.setTask(uiTask);
