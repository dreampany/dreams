 ...
 */
interface StateDataSource : DataSource<State> {

     fun getCountById(id: String, type: String, subtype: String): Int

     fun getCountByIdRx(id: String, type: String, subtype: String): Maybe<Int>

     fun getCount(type: String, subtype: String, state: String): Int

     fun getCountRx(type: String, subtype: String, state: String): Maybe<Int>

     fun getCountById(id: String, type: String, subtype: String, state: String): Int
     ...
     fun getItemNotStateOrderByRx(
        type: String,
        subtype: String,
        state: String
    ): Maybe<State>

     fun getItemOrderByRx(type: String, subtype: String): Maybe<State>
