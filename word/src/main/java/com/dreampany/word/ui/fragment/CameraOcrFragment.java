...
import com.dreampany.word.databinding.FragmentCameraOcrBinding;
 ...
 */
@ActivityScope
public class CameraOcrFragment extends BaseMenuFragment {
    ...
    public void onResume() {
        super.onResume();
        vm.loadOcrOfCamera(getParent(), false);
    }
...
/*            case R.id.button_like:
    ...
    private void initView() {
        ...
        binding = (FragmentCameraOcrBinding) super.binding;
